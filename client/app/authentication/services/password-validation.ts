...
export class PasswordValidation {
  ...
  public static displayRequeriments(str) {
    ...
    if(Object.keys(str).length) {
      ...
      let requeriments = [];
      if(str.passLength) requeriments.push(" 6 characters");
      if(str.passNumber) requeriments.push(" 1 number");
      if(str.passUpper) requeriments.push(" 1 uppercase");
      if(str.passLower) requeriments.push(" 1 lowercase");
